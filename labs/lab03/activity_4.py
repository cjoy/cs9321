...
def main():
  ...
  df_1a = dataframe.query("species == 'Iris-setosa'").plot.scatter(x='sepal_length', y='sepal_width', label='setosa', ax=axes[0])
  ...
  df_1b = dataframe.query("species == 'Iris-setosa'").plot.scatter(x='petal_length', y='petal_width', label='setosa', ax=axes[1])
